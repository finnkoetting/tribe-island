...
const manifest: Record<string, LoaderFn> = {
    ...
    "buildings/townhall/lvl1": () => import("./buildings/townhall/lvl1.png"),
    "buildings/watchtower/lvl1": () => import("./buildings/watchtower/lvl1.png"),
    "buildings/sleep_hut/lvl1": () => import("./buildings/sleep_hut/lvl1.png"),
